...
test('registro criado pela API aparece na lista e no filtro de ativos', async ({ page, request }) => {
...
test('Próximo passo avança depois que a etapa é concluída', async ({ page }) => {
  await page.goto('/');
...
test('formulário permanece integralmente visível em 390 px', async ({ page }) => {
